    ...
    <Container className="d-flex justify-content-center align-items-center" style={{ height: '100vh' }}>
      <Card style={{ maxWidth: 400, width: '100%' }}>
        <Card.Body className="p-4">
          <Card.Title className="text-center mb-1" style={{ color: '#1B8C3E', fontSize: '1.8rem', fontWeight: 700 }}>TaskFlow</Card.Title>
          <p className="text-center text-muted mb-3" style={{ fontSize: '0.9rem' }}>Connectez-vous pour continuer</p>
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Button type="submit" className="w-100" style={{ background: '#1B8C3E', border: 'none' }} disabled={loading}>
